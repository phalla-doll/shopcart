    ...
    <footer className="bg-white border-t border-gray-100 pt-16 pb-8 mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          {/* Customer Area */}
          <div>
            <h3 className="font-bold text-lg mb-4 text-gray-900">Customer Area</h3>
            <ul className="space-y-3">
        ...
        <div className="pt-8 border-t border-gray-100 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex gap-2">
              ...
              <div className="w-10 h-6 bg-gray-100 rounded flex items-center justify-center text-[10px] font-bold text-gray-500">MC</div>
              <div className="w-10 h-6 bg-gray-100 rounded flex items-center justify-center text-[10px] font-bold text-gray-500">PP</div>
            </div>
          </div>
        </div>
      </div>
